...
def load_data(csv_path: str) -> pd.DataFrame:
    ...
    # โหลดข้อมูล CSV
    # ==========================
    file_path = "/home/inc/ros2_ws/src/navigation_system/logs11saty/waypoints_clean.csv"   
...
def build_charts(df: pd.DataFrame, out_path: str) -> str:
    ...
    # ==========================
    # ปรับความหนาเส้นตรงนี้
    # ==========================
    SPEED_LINEWIDTH = 3.0
    HEADING_LINEWIDTH = 3.0
    # ==========================
    ...
    ax1.plot(
        ...
        speeds,
        color="#3b82f6",
        linewidth=SPEED_LINEWIDTH,   # ← ความหนาเส้น speed
        marker="o",
        markersize=3,
    ...
    ax2.plot(
        ...
        headings,
        color="#f97316",
        linewidth=HEADING_LINEWIDTH,   # ← ความหนาเส้น heading
        marker="o",
        markersize=3,
